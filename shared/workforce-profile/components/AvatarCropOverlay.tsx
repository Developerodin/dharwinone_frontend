...
import wizardStyles from "../engine/workforce-wizard.module.css";
...
export function AvatarCropOverlay({
  ...
  return (
    <WizardOverlayShell
      ...
      testId="avatar-crop-overlay"
      panelRole="dialog"
      panelAriaLabel="Edit profile photo"
      panelClassName={`${styles.dialog} max-w-md !p-0`}
    >
